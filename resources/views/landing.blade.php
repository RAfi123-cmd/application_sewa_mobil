<x-front-layout>
    ...
    <section class="container relative pb-[100px] pt-[30px]">
        <div class="flex flex-col items-center justify-center gap-[30px]">
            ...
            <div class="relative">
                ...
                <img src="/images/porsche.webp" alt="" class="w-full max-w-[963px] z-10 relative" data-aos="zoom-in" data-aos-delay="950">
            </div>
            <div class="flex flex-col lg:flex-row items-center justify-around lg:gap-[60px] gap-7">
                ...
                <div class="p-1 rounded-full bg-primary group" data-aos="zoom-in" data-aos-delay="3400">
                    <a href="#popularCars" class="btn-primary">
                        ...
                        <img src="/svgs/ic-arrow-right.svg" alt="" class="opacity-0 group-hover:opacity-100 group-hover:-translate-x-1 transition-all duration-[320ms]">
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-[29px]">
                @foreach ($items as $item)
                    ...
                    <div class="card-popular">
                        ...
                        <img src="{{ $item->thumbnail }}" alt="" class="rounded-[18px] min-w-[216px] w-full h-[150px]">
    ...
    <section class="container relative pt-[100px]">
        <div class="flex items-center flex-col md:flex-row flex-wrap justify-center gap-8 lg:gap-[120px]">
            <img src="/images/illustration-01.webp" alt="" class="w-full lg:max-w-[536px]">
                ...
                <div class="flex flex-col gap-[30px]">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-normal text-secondary">Just sit and wait</p>
                        </div>
                    </div>
        ...
        <div class="grid md:grid-cols-2 gap-x-[50px] gap-y-6 max-w-[910px] w-full mx-auto">
            <a href="#!" class="px-6 py-4 border rounded-[24px] border-grey h-min accordion max-w-[430px]" id="faq1">
                <div class="flex items-center justify-between gap-1">
                    ...
                    <img src="/svgs/ic-chevron-down-rounded.svg" alt="" class="transition-all">
                </div>
            ...
            <a href="" class="px-6 py-4 border rounded-[24px] border-grey h-min accordion max-w-[430px]" id='faq2'>
                <div class="flex items-center justify-between gap-1">
                    ...
                    <img src="/svgs/ic-chevron-down-rounded.svg" alt="" class="trasition-all">
                </div>
    ...
    <section class="relative bg-[#060523]">
        <div class="container py-20">
            ...
            <div class="absolute bottom-[-30px] right-0 lg:w-[764px] max-h-[322px] hidden lg:block">
                <img src="/images/porsche.webp" alt="">
            </div>
        </div>
    </section>
