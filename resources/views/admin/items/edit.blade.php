<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            ...
            item &raquo; Sutting &raquo; #{{ $item->id }} {{ $item->name }} 
        </h2>
    </x-slot>
                ...
                <form action="{{ route('admin.items.update', $item->id) }}" class="w-full" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
                        <div class="w-full">
                            ...
                            <input type="text" name="name" id="grid-last-name" value="{{ old('name') ?? $item->name }}"
                    ...
                    <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
                        <div class="w-full">
                            ...
                            <input type="text" name="features" id="grid-last-name" value="{{ old('features') ?? $item->features }}"
                                class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none
                                focus:bg-white focus:border-gray-500" placeholder="Nama" required>
                            <div class="mt-2 text-sm text-gray-500">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 px-0 mt-4 mb-6">
                        <div class="min-w-0">
                            ...
                            <input type="number" name="price" id="grid-last-name" value="{{ old('price') ?? $item->price }}"
                                class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none
                        ...
                        <div class="min-w-0">
                            ...
                            <input type="number" name="star" id="grid-last-name" value="{{ old('star') ?? $item->star }}"
                                class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none
                        ...
                        <div class="min-w-0">
                            ...
                            <input type="number" name="review" id="grid-last-name" value="{{ old('review') ?? $item->review }}"
                                class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none
